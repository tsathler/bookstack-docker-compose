...
#login{position:fixed;inset:0;display:grid;place-items:center;background:#0f172acc;padding:20px}#login[hidden]{display:none}.login-card{max-width:420px;width:100%;padding:24px}.login-card h2{margin-top:0}.login-card input{width:100%;padding:12px;margin:12px 0;border:1px solid #cbd5e1;border-radius:8px;font:inherit}.login-card button{height:44px;width:100%}.error{color:#b91c1c;margin-top:10px;min-height:1.2em}
